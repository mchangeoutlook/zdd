...
public class Movinguniquedistribution extends Thread {

	private String ip = null;
	private String port = null;

	public Movinguniquedistribution(String theip, String theport) {
		ip = theip;
		port = theport;
	}
		...
		Filekvutil.walkdata(indexfile, new Filedatawalk() {
			...
			public Filedatawalkresult data(long datasequence, long dataseqincludedeleted, String index, String key,
				...
				if (isvaluedeleted || datasequence < processednumofdata) {
					...
					try {
						Uniqueindexclient ic = Uniqueindexclient.getinstance(namespace, index);
						if (filters.length != 0) {
