...
public class Bigindexconfig {
	...
	public static void init(String namespace) throws Exception {
		...
		System.out.println(new Date()+" ==== generated bigindexconfig ["+parentfolderip_port.size()+"] index servers and ["+hash_ipport.size()+"] hashes under namespace ["+namespace+"]");
		System.out.println(new Date()+" ==== please restart configserver to make new index distribution to take effect");
	}
