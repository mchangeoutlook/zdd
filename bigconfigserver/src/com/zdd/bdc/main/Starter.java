...
public class Starter {
	public static void main(String[] s) throws Exception {
		...
		new Thread(new Runnable() {
			...
			public void run() {
				try {
					Theserver.startblocking(ip, Integer.parseInt(Configserver.readconfig("core", "core", "configserverport")), pending, 10, Configserver.class);
				} catch (Exception e) {
		...
		while(!"pending".equals(Configserver.readconfig("core", "pending", ip+":"+Configserver.readconfig("core", "core", "configserverport")))) {
			Thread.sleep(30000);
		}
