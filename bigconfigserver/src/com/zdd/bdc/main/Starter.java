...
public class Starter {
	public static void main(String[] s) throws Exception {
		...
		while(!STATIC.REMOTE_CONFIGVAL_PENDING.equals(Configserver.readconfig(STATIC.NAMESPACE_CORE, STATIC.REMOTE_CONFIGFILE_PENDING, ip+STATIC.SPLIT_IP_PORT+Configserver.readconfig(STATIC.NAMESPACE_CORE, STATIC.REMOTE_CONFIGFILE_CORE, STATIC.REMOTE_CONFIGKEY_CONFIGSERVERPORT)))) {
			Thread.sleep(30000);
		}
