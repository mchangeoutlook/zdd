...
public class Readroot implements Theclientprocess{
	...
	public Readroot(String thenamespace, String thefilter, String yesterday, String statkey, String theip, int theport) {
		namespace  = thenamespace;
		filter = thefilter;
		ip = theip;
		port = theport;
		readleaf = new Readleaf(namespace, filter, yesterday, statkey, ip, port);
	}
	@Override
