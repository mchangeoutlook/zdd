...
public class Fileutil {
	...
	private static ByteBuffer formatdatapair(byte[] value1, int value1maxlength, boolean isvalue1deleted, byte[] value2,
			int value2maxlength, boolean isvalue2deleted) {
	...
	// return
	// Vector[value1maxlength,value1,value1length,value2maxlength,value2,value2length]
					...
					if (res == null) {// move to next data
						...
						if (res.getdataction() == Filedatawalkresult.DATA_DELETE) {
							ByteBuffer towrite = formatdatapair(value1, Integer.parseInt(new String(value1maxlength)),
									true, value2, Integer.parseInt(new String(value2maxlength)), true);
							if (reverse) {
							...
							ByteBuffer towrite = formatdatapair(res.getvalue1(),
									Integer.parseInt(new String(value1maxlength)), false, res.getvalue2(),
									Integer.parseInt(new String(value2maxlength)), false);
							if (reverse) {
								// keep current position;
							} else {
								sbc.position(sbc.position() - towrite.capacity());
	...
	public static Vector<byte[]> readallvalue2byvalue1(byte[] value1, int defaultnumofvalues, boolean reverse,
